...
- **Volcanoes:** Smithsonian Global Volcanism Program — Volcanoes of the World (Holocene-active subset). Database accessed via the [scottyhq/votw](https://github.com/scottyhq/votw) GitHub mirror of the Smithsonian export (Smithsonian's direct download endpoints block automated requests). License: free academic / educational / non-commercial use with attribution. Citation: *Global Volcanism Program. Volcanoes of the World. Smithsonian Institution. https://volcano.si.edu*.
